...
(function() {
    ...
    $("#loanDataTable").length && $(document).ready((function() {
    ...
    $("#walletDataTable").length && $(document).ready((function() {
    ...
    $("#accountDataTable").length && $(document).ready((function() {
    ...
    $("#allTransactions").length && $(document).ready((function() {
